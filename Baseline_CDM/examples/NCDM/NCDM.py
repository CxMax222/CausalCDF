...
'''
train_data = pd.read_csv("../../data/a0910_yuanshi/train.csv")
valid_data = pd.read_csv("../../data/a0910_yuanshi/valid.csv")
test_data = pd.read_csv("../../data/a0910_yuanshi/test.csv")
df_item = pd.read_csv("../../data/a0910_yuanshi/item.csv")
...
cdm.train(train_set, test_set, epoch=10, device="cpu",lr=0.002)
